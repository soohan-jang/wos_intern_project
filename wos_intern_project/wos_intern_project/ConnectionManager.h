...
extern NSString *const KEY_EDITOR_DRAWING_UPDATE_ORIGIN_X;
extern NSString *const KEY_EDITOR_DRAWING_UPDATE_ORIGIN_Y;
extern NSString *const KEY_EDITOR_DRAWING_UPDATE_SIZE_WIDTH;
extern NSString *const KEY_EDITOR_DRAWING_UPDATE_SIZE_HEIGHT;
