...
@interface DecorateTextMenuView ()
...
@implementation DecorateTextMenuView
...
- (IBAction)tappedDoneButton:(id)sender {
    ...
    PEDecorate *data = [[PEDecorate alloc] initWithImage:[self textViewConvertToImage] scale:Scale];
    [self.delegate decorateTextMenuViewDidFinished:data];
}
...
- (IBAction)tappedCancelButton:(id)sender {
    ...
    [self.delegate decorateTextMenuViewDidCancelled];
}
