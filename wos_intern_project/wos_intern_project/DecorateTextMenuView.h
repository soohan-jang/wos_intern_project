...
@protocol DecorateTextMenuViewDelegate;

@interface DecorateTextMenuView : UIView

@property (weak, nonatomic) id<DecorateTextMenuViewDelegate> delegate;
 ...
 */
@protocol DecorateTextMenuViewDelegate <NSObject>
@required
/**
