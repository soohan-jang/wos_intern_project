...
#import "PECropView.h"
#import "CropPhotoFilterImageViewCell.h"
...
@interface CropPhotoViewController () <UICollectionViewDelegateFlowLayout, UICollectionViewDataSource>
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    CropPhotoFilterImageViewCell *cell = (CropPhotoFilterImageViewCell *)[collectionView cellForItemAtIndexPath:indexPath];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    CropPhotoFilterImageViewCell *cell = (CropPhotoFilterImageViewCell *)[collectionView dequeueReusableCellWithReuseIdentifier:NSStringFromClass([CropPhotoFilterImageViewCell class])
